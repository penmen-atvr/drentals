...
const styles = StyleSheet.create({
  ...
  heroBadgeTxt: { color: '#fff', fontSize: 11, fontWeight: '900', letterSpacing: 1.5 },
  ...
  hCardTag: { color: ACCENT, fontSize: 10, fontWeight: '900', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 4 },
  ...
  gPlaceholder: { flex: 1 },
  gTitle: { color: '#FAFAFA', fontSize: 14, fontWeight: '700', paddingHorizontal: 12, marginBottom: 4 },
  gPrice: { color: ACCENT, fontSize: 13, fontWeight: '800', paddingHorizontal: 12 },
});
