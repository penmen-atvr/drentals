...
export default function Hero() {
  return (
    <div className="py-20 md:py-32 lg:py-48 bg-zinc-900 border-b border-zinc-800">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl">
          <div className="inline-block mb-4 px-3 py-1 border border-red-600 bg-zinc-950">
            <span className="text-red-500 font-mono text-xs md:text-sm tracking-widest">CAMERA RENTALS IN HYDERABAD</span>
          </div>
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white mb-6 tracking-wide leading-tight">
            <span className="text-red-500">D&apos;RENTALS</span> CINEMA EQUIPMENT
          </h1>
          <p className="text-base md:text-xl text-zinc-300 mb-10 max-w-2xl font-body">
